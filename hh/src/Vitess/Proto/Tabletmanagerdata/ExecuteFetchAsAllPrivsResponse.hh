...
namespace Vitess\Proto\Tabletmanagerdata {
  ...
  class ExecuteFetchAsAllPrivsResponse extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'tabletmanagerdata.ExecuteFetchAsAllPrivsResponse');
     ...
     * Clear <result> value
     *
     * @return \Vitess\Proto\Tabletmanagerdata\ExecuteFetchAsAllPrivsResponse
     */
