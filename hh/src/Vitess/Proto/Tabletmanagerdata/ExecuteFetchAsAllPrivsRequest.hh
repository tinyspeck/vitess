...
namespace Vitess\Proto\Tabletmanagerdata {
  ...
  class ExecuteFetchAsAllPrivsRequest extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'tabletmanagerdata.ExecuteFetchAsAllPrivsRequest');
     ...
     * Clear <query> value
     *
     * @return \Vitess\Proto\Tabletmanagerdata\ExecuteFetchAsAllPrivsRequest
     */
