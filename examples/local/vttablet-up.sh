...
then
    ...
    optional_auth_args='-grpc_server_auth static -grpc_server_auth_static_file ./grpc_static_auth.json -tablet_grpc_static_auth_creds ./grpc_static_client_auth.json'
fi
