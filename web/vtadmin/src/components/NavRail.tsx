...
export const NavRail = () => {
    ...
    const tableDefinitions = React.useMemo(() => getTableDefinitions(schemas), [schemas]);
        ...
        <div className={style.container}>
            ...
            <div className={style.navLinks}>
                ...
                <ul className={style.navList}>
                    ...
                    <li>
                        <NavRailLink icon={Icons.keyS} text="Schemas" to="/schemas" count={tableDefinitions.length} />
                    </li>
                    <li>
