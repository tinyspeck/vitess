...
type Tablet struct {
	...
	// Metadata is a map of arbitrary key-value pairs of metadata associated
	// with a tablet, specific to your particular environment. VTAdmin on its
	// own will never populate this field, but running with a custom
	// tablet-metadata-plugin will cause this field to be populated with
	// whatever specific metadata needs you have.
...
func (m *Tablet) GetMetadata() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "vtadmin.Tablet.MetadataEntry")
...
var fileDescriptor_609739e22a0a50b3 = []byte{
	...
	,
}
...
func (m *Tablet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Metadata) > 0 {
		for k := range m.Metadata {
			...
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintVtadmin(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
	...
	if len(m.FQDN) > 0 {
		i -= len(m.FQDN)
		copy(dAtA[i:], m.FQDN)
		i = encodeVarintVtadmin(dAtA, i, uint64(len(m.FQDN)))
		i--
		dAtA[i] = 0x22
	}
	if m.State != 0 {
...
func (m *Tablet) Size() (n int) {
	...
	if len(m.Metadata) > 0 {
		for k, v := range m.Metadata {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovVtadmin(uint64(len(k))) + 1 + len(v) + sovVtadmin(uint64(len(v)))
			n += mapEntrySize + 1 + sovVtadmin(uint64(mapEntrySize))
		}
	}
	if m.XXX_unrecognized != nil {
