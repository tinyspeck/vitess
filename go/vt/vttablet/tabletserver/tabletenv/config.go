...
func init() {
	...
	flag.IntVar(&Config.MaxInflightQueries, "queryserver-config-max-inflight-queries", DefaultQsConfig.MaxInflightQueries, "queryserver maximum number of in-flight queries. Above this count queries will be admission controlled into the queryserver")
