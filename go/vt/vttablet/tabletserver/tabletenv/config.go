...
func init() {
	...
	flag.IntVar(&Config.AppDebugPoolSize, "client-appdebug-pool-size", DefaultQsConfig.AppDebugPoolSize, "size of a special pool that will be used if the client making the request is the app-debug user.")
	flag.StringVar(&Config.AppDebugUsername, "client-appdebug-username", DefaultQsConfig.AppDebugUsername, "username that will be identified as a debugger user. When CallerID of a client request matches this user, appdebug pool will be used.")
