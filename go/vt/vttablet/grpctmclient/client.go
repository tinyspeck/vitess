...
func (client *Client) UpdateTabletControls(ctx context.Context, tablet *topodatapb.Tablet) error {
	cc, c, err := client.dial(tablet)
	if err != nil {
		return err
	}
	defer cc.Close()
	c.UpdateTabletControls(ctx, &tabletmanagerdatapb.UpdateTabletControlsRequest{})
	return err
}
