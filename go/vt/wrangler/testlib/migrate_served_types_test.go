...
func TestMigrateServedTypes(t *testing.T) {
	...
	dest1Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest1Master.FakeMysqlDaemon, dbClientFactory1, dbClient1.DBName())
	...
	dest2Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest2Master.FakeMysqlDaemon, dbClientFactory2, dbClient2.DBName())
	// select * from _vt.vreplication during Open
...
func TestMultiShardMigrateServedTypes(t *testing.T) {
	...
	dbClient1 := binlogplayer.NewMockDBClient(t)
	dbClientFactory1 := func() binlogplayer.DBClient { return dbClient1 }
	dest1Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest1Master.FakeMysqlDaemon, dbClientFactory1, "db")
	// select * from _vt.vreplication during Open
	dbClient1.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	if err := dest1Master.Agent.VREngine.Open(context.Background()); err != nil {
		t.Fatal(err)
	...
	dbClient2 := binlogplayer.NewMockDBClient(t)
	dbClientFactory2 := func() binlogplayer.DBClient { return dbClient2 }
	dest2Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest2Master.FakeMysqlDaemon, dbClientFactory2, "db")
	// select * from _vt.vreplication during Open
	dbClient2.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	if err := dest2Master.Agent.VREngine.Open(context.Background()); err != nil {
		t.Fatal(err)
	...
	dbClient1 = binlogplayer.NewMockDBClient(t)
	dbClientFactory1 = func() binlogplayer.DBClient { return dbClient1 }
	dest3Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest3Master.FakeMysqlDaemon, dbClientFactory1, "db")
	// select * from _vt.vreplication during Open
	dbClient1.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	...
	dbClient2 = binlogplayer.NewMockDBClient(t)
	dbClientFactory2 = func() binlogplayer.DBClient { return dbClient2 }
	dest4Master.Agent.VREngine = vreplication.NewEngine(ts, "", nil, dest4Master.FakeMysqlDaemon, dbClientFactory2, "db")
	// select * from _vt.vreplication during Open
	dbClient2.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
